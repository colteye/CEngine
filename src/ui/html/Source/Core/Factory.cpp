...
void Factory::Initialise()
{
	...
	// Treat the standard HTML root as the document container instead of
	// instancing a visible custom wrapper element.
	XMLParser::RegisterNodeHandler("html", MakeShared<XMLNodeHandlerBody>());
